...
function cmds(){
  ...
  echo "${bold} flight ${normal}     - checks in to southwest flight (enter confirmation code after"
}
...
function flight(){
  ...
  python ~/Documents/Python/SouthwestCheckin/checkin.py $confirmationNumber Pulkit Mahajan
}

function pages(){
  echo "Listing current GH-Pages sites"
  python3 ~/Documents/Automation/Commands/automateGitStuff.py
